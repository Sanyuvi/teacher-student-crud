...
function AddStudent() {
  ...
  return (
    <>
      <h1 className="form-control bg-secondary text-white">Add Student</h1>
      <form onSubmit={ADDstudent}>
        ...
        <div className="dropdown mb-3 m-3 text-start">
          ...
          <input
            className="text-center btn btn-secondary fw-bold m-3"
            style={{ width: "10vw" }}
            value={class1}
            readOnly
          />
        ...
        <div className="dropdown mb-3 m-3 text-start">
          ...
          <ul className="dropdown-menu">
            {teacher.map((te, i) => {
              return (
                <li key={i} onClick={() => setTeacher(te.name)}>
                  {te.name}
                </li>
              );
            })}
